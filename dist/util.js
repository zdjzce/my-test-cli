...
var prompt = function prompt() {
  return new Promise(function (resolve) {
    inquirer.prompt(promptList.promptList).then(function (answer) {
      resolve(answer);
    });
  });
};
...
var downloadTemplate = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(dir, ProjectName) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve) {
              var _iterator, _step, choice_item;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _iterator = _createForOfIteratorHelper(directoryTree.choice_project);
                    _context2.prev = 1;
                    _iterator.s();
                  case 3:
                    ...
                    process.chdir(dir);
                    _context2.next = 9;
                    return createDirectories(choice_item.root_directory);
                  case 9:
                    resolve();
                  case 10:
                    _context2.next = 3;
...
function cloneLibrary(directory) {
  return new Promise(function (resolve) {
    exec("git clone ".concat(directory.repo_url), function (error, stdout, stderr) {
      ...
      stderr && console.log("".concat(stderr));
      spawn('sh', ['-c', "cd ".concat(directory.name, " && npm install")]);
      resolve();
    });
  });
}
